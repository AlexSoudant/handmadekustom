  ...
  const creationsTable = [
    {
      tip: "Assemblage",
      title: "Fabrication",
      descr: "Jardinière en acier corten.",
    },
    ...
    { tip: "Assemblage", title: "Soudure", descr: "Tige Acier Inox Alu." },
    {
      tip: "Assemblage",
      title: "Fabrication",
      descr: "Chariot de dévidage en acier galvanisé et aluminium.",
    },
    { tip: "Assemblage", title: "Soudure", descr: "Tige Acier Inox Alu." },
    { tip: "Assemblage", title: "Fabrication", descr: "Plateforme d'accès." },
    {
      tip: "Assemblage",
      title: "Fabrication",
      descr: "Escalier d'accès de 5m50 de hauteur pour une cuve à acide.",
    },
    ...
    { tip: "Outillage", title: "Mesure ", descr: "Laser." },
    {
      ...
      title: "Soudure",
      descr:
        "Rechargement de pièce d'usure avec du fil chargé à la poussière de tungstène.",
    },
    {
      tip: "Technique",
      title: "Réparation",
      descr: "Redressage de godet et remplacement de la lame en acier dur.",
    },
    {
      tip: "Outillage",
      title: "Fabrication",
      descr:
        "Outillage permettant la fabrication d'un faisceau électrique de bus.",
    },
    { tip: "Outillage", title: "Mesure ", descr: "Laser." },
    {
      tip: "Outillage",
      title: "Fabrication",
      descr: "Plateformes mobiles et fixes pour Heuliez bus.",
    },
                    ...
                    <div className="flex relative h-80">
                      ...
                      <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-80">
                        <h2 className="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">
                          {creationsTable[index].tip}
                        </h2>
                        <h1 className="title-font text-lg font-medium text-gray-900 mb-3">
                          {creationsTable[index].title}
                        </h1>
                        <p className="leading-relaxed">
                          {creationsTable[index].descr}
                        </p>
                      </div>
                    </div>
                  </div>
